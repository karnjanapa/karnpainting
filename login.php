...
// Uncommenting this block would check if there's an active session. 
// If not, it would exit the script and return a JSON response indicating a session error.
// However, it's currently commented out, so it won't execute.
if (!$_SESSION) {
    exit(json_encode([
        'status' => false,
